...
//20150112날짜의 모든 종목을 추출하여 파일 만들기
		...
		File k36_f1 = new File("C:\\Users\\kopo\\Desktop\\day_data\\StockDailyPrice_20150112.csv");// 저장할 csv파일을 지정해준다.
		...
		System.out.printf("Program End[%d][%d]records\n", k36_cnt, k36_wcnt);// 모든과정이 끝나면 프로그램이 끝났다고 읽어온값과 추출한 값의 숫자를
																		// 출력한다.
