...
public class main13 {
		...
		public static void main(String[] args) throws IOException {
			...
			File k36_f = new File("C:\\Users\\kopo\\Desktop\\day_data\\StockDailyPrice_Samsung.csv");// 지정된 파일을 불러온다
			...
			System.out.printf("Program End[%d][%d]records\n", k36_min, k36_max);// 모든과정이 끝나면 프로그램이 끝났다고 알려주며 수정된 값과 입력된 값의 숫자를
																			// 출력한다.
		}
